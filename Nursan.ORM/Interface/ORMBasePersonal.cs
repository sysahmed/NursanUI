...
{
    public class ORMBasePersonal<IEntity, OT> : IORM<IEntity> where IEntity : class, new()
         where OT : class, new()
    {
        ...
        #region Constractor
        public ORMBasePersonal()
        {
            _commmand = new SqlCommand();
            _commmand.Connection = ToolsPersonal.SqlConnection;
            type = typeof(IEntity);
        }
        ...
        public Result<List<IEntity>> Select(string whereQuery)
        {
            using (SqlListening listener = new SqlListening())
            {
                ...
                SqlDataAdapter adp = new SqlDataAdapter($" {query} {whereQuery}", ToolsPersonal.SqlConnection);
                return adp.ToListPersonal<IEntity>();
            }
        }
        #endregion
        ...
        public Result<int> InsertReturnID(IEntity entity)
        {
            ...
            _commmand.Parameters.Clear();
            return _commmand.ExecIDPersonal();
        }
        #endregion
