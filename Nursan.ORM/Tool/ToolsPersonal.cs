...
{
    public static class ToolsPersonal
    {
        ...
        public static string _sqlConnectionString = $"data source={XMLTools.XMLSeverIp.XmlServerIP()};initial catalog=Personal;user id=sa;password=wrjkd34mk22;TrustServerCertificate=True";
        ...
        public static Result<List<IEntity>> ToListPersonal<IEntity>(this SqlDataAdapter adp) where IEntity : class, new()
        {
            try
            {
        ...
        public static Result<bool> ExecPersonal(this SqlCommand command)
        {
            try
            {
        ...
        public static Result<int> ExecIDPersonal(this SqlCommand command)
        {
            try
            {
                if (command.Connection.State != ConnectionState.Open)
