...
{
    public class RepositoryORM<IEntity> : IRepository<IEntity> where IEntity : class
    {
        protected readonly DbContext _context;
        private readonly DbSet<IEntity> _dbSet;
        private static string msage;
        public RepositoryORM(DbContext context)
        {
            _context = context;
            _dbSet = _context.Set<IEntity>();
        }
        IDataResult<DateTime> IRepository<IEntity>.TarihGetir()
        {
            try
            {
        ...
        /// <returns></returns>
        IResults IRepository<IEntity>.Delete(IEntity entity)
        {
            try
            {
        ...
        /// <returns></returns>
        IDataResult<List<IEntity>> IRepository<IEntity>.GetAll(Expression<Func<IEntity, bool>> predicate)
        {
            try
            {
                using (var contect = new UretimOtomasyonContext())
                {
        ...
        /// <param name="id"></param>
        /// <returns></returns>
        IDataResult<IEntity> IRepository<IEntity>.GetById(int id)
        {
            try
            {
        ...
        /// <param name="predicate"></param>
        /// <returns></returns>
        IDataResult<IEntity> IRepository<IEntity>.Get(Expression<Func<IEntity, bool>> predicate)
        {
            try
            {
                using (var contect = new UretimOtomasyonContext())
        ...
        IDataResult<IEntity> IRepository<IEntity>.Add(IEntity entity)
        {
        ...
        /// <param name="entity"></param>
        /// <returns></returns>
        IDataResult<IEntity> IRepository<IEntity>.Update(IEntity entity)
        {
            try
            {
                using (var context = new UretimOtomasyonContext())
        ...
        /// <param name="id"></param>
        /// <returns></returns>
        IResults IRepository<IEntity>.Delete(int id)
        {
            try
            {
