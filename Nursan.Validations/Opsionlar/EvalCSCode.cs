namespace Nursan.UI
{
    public class EvalCSCode
    {
        ...
        {
            //EvalCSCode.EvalCSCode.callAFunc();
            //System.Windows.Forms.MessageBox.Show("callBFunc: Hello from another independent function in this assembly","HyFromBFunc", MessageBoxButtons.OK, MessageBoxIcon.Information);
        }
    }
}
//End Namespace