// using AxWMPLib; // Ще се разкоментира след генериране на interop DLL-ите

namespace Nursan.UI
{
    partial class Gromet
    {
        /// <summary>
        ...
        {
            System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(Gromet));
