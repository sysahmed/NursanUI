...
public partial class PersonalContext : DbContext
{
    ...
    protected override void OnConfiguring(DbContextOptionsBuilder optionsBuilder)
        ...
        => optionsBuilder.UseSqlServer($"Server={sqlConnectionString};Database=Personal;User Id=sa;Password=wrjkd34mk22;TrustServerCertificate=True");
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        modelBuilder.Entity<Personal>(entity =>
        {
            ...
            entity.Property(e => e.JOB_POSITION).HasColumnName("JOB_POSITION");
            entity.Property(e => e.LAST_DIR).HasColumnName("LAST_DIR");
